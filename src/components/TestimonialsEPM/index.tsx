...
const TestimonialsEPM = () => {
  return (
    <section className="dark:bg-bg-color-dark bg-gray-light relative z-10 py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          title="Unlock Strategic Insights with Oracle Cloud EPM"
          paragraph=" "
          center
        />
...
<div className="w-full">
      ...
      <div className="flex items-center">
        ...
        •	Streamline Financial Planning: Achieve greater accuracy in budgeting, forecasting, and financial reporting.
        </p>
        ...
        •	Accelerate Close Cycles: Automate and speed up your financial close with real-time data.
        </p>
        <p className="mb-8 border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        •	Improve Decision-Making: Gain actionable insights and enhance business performance with integrated analytics.
        </p>
    ...
    <div className="w-full">
      ...
      <div className="flex items-center">
        ...
        {/* <div className="mb-5 flex items-center space-x-1">{ratingIcons}</div> */}
        <p className="mb-8 border-t border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        •	Cloud Flexibility: Access your financial data anytime, anywhere, with scalable cloud solutions.
        </p>
        <p className="mb-8 border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        •	Integrated Systems: Seamlessly connect finance, operations, and strategy for holistic decision-making.
        </p>
        <p className="mb-8 border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        •	Enhanced Collaboration: Enable real-time collaboration across departments for smarter, faster decisions.
        </p>
    ...
    <div className="w-full">
      ...
      <div className="flex items-center">
        ...
        {/* <div className="mb-5 flex items-center space-x-1">{ratingIcons}</div> */}
        <p className="mb-8 border-t border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        1.	Assessment: Understand your current systems and goals.
        </p>
        <p className="mb-8 border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        2.	Customization: Tailor Oracle Cloud EPM to fit your business.
        </p>
        <p className="mb-8 border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        3.	Implementation: Seamlessly deploy Oracle Cloud EPM across your organization.
        </p>
        <p className="mb-8 border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        4.	Training & Support: Equip your team and ensure ongoing success.
        </p>
    ...
    <div className="w-full">
      ...
      <div className="flex items-center">
          ...
          <div className="w-full">
            <h3 className="mb-1 text-lg font-semibold text-dark dark:text-white lg:text-base xl:text-lg">
            Ready to Transform Your Financial Management?            </h3>
            {/* <p className="text-sm text-body-color">{designation}</p> */}
          </div>
        </div>
        {/* <div className="mb-5 flex items-center space-x-1">{ratingIcons}</div> */}
        <p className="mb-8 border-t border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
        •	Get Started: Schedule a free consultation to learn how Oracle Cloud EPM can streamline your financial operations.
        </p>
        <p className="mb-8 border-body-color border-opacity-10 pt-1 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
...
export default TestimonialsEPM;
